...
const ShimmerButton = React.forwardRef((
  ...
  return (
    (<button
      ...
      className={cn(
        "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-border px-6 py-3 text-white [background:var(--bg)] [border-radius:var(--radius)]",
